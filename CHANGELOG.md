...
- Using the code from the [polygon-clipping](https://github.com/mfogel/polygon-clipping) library's main branch ()
- Applied changes from these PRs
  - https://github.com/mfogel/polygon-clipping/commit/73ca4da6fe373fef6e16fb07fd8d4847a0512f72
  - https://github.com/mfogel/polygon-clipping/pull/130/files
- Reverted changes from this [PR]( https://github.com/mfogel/polygon-clipping/pull/147/files#), as they were conflicting with lb-editor test configs
